...
const DoctorSidebar=()=>{
    ...
    return(
      ...
      <div className="flex items-center justify-center h-16 bg-[#05acb4]">
        <span className="text-white font-bold uppercase"><img src={logo} alt="logo" className=' w-44 rounded-lg shadow-xl'/></span>
      </div>
      
      <div className="flex flex-col flex-1 overflow-y-auto">
        <nav className="flex-1 px-2 py-4 bg-[#05acb4]">
          <span onClick={()=>navigate("/doctor")}  className="flex items-center px-4 py-2 gap-5 text-[#364f6b] hover:bg-gray-700">
          <FontAwesomeIcon icon={faChartPie} />
            Dashboard
          </span>
          <span onClick={()=>navigate("/doctor/addSlot")} className="flex items-center px-4 py-2 mt-2 gap-5 text-[#364f6b] hover:bg-gray-700">
