  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-40 flex items-center justify-center pointer-events-none">
        <motion.div
          className="absolute top-62 left-[60vw] pointer-events-auto"
        ...
        {showHiMessage && (
          <motion.img
            className="h-60 absolute z-50 top-32 left-2/4  pointer-events-auto"
            src={hiMessage}
        ...
        {showMessage && (
          <motion.img
            className="h-60 absolute z-50 top-32 left-1/2 pointer-events-auto"
