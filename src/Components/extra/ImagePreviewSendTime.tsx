...
const ImagePreviewSendTime=({imagePreview,setShowModal,handleSendImage,side,loading}:{imagePreview:string,setShowModal:(action:boolean)=>void,handleSendImage:()=>void,side:"user"|"doctor",loading:boolean})=>{
    return (
      <>
