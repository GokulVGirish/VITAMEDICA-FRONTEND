      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 leading-tight mb-4">
          ...
          <h2 className="text-center mb-4 font-bold">
            {" "}
            {moment(parsedData.start).format("h:mm A")}- {moment(parsedData.end).format("h:mm A")}
          </h2>
          <div className=" flex justify-center">
            <button onClick={()=>navigate("/")} className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg">
              Go Home
            </button>
          </div>
        </p>
