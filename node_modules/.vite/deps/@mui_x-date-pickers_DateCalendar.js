import {
  ...
  useNow,
  useUtils
} from "./chunk-3RBGFRE4.js";
import "./chunk-7UBUC4MG.js";
import {
  alpha,
  capitalize,
  chainPropTypes,
...
import "./chunk-6WASIMY2.js";
import {
  _extends
} from "./chunk-EQCCHGRT.js";
import "./chunk-74QTVEIN.js";
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime4.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React7.cloneElement(element, {
      classNames: transitionClasses
    }),
    role: "presentation",
    children: (0, import_jsx_runtime4.jsx)(CSSTransition_default, _extends({
      mountOnEnter: true,
      unmountOnExit: true,
...
function WrappedDay(_ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(Day, _extends({}, dayProps, {
    day,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const {
    ...
    readOnly,
    reduceAnimations,
    renderLoading = () => (0, import_jsx_runtime5.jsx)("span", {
      children: "..."
    }),
    slideDirection,
    TransitionProps,
  ...
  return (0, import_jsx_runtime5.jsxs)(PickersCalendarDayRoot, {
    role: "grid",
    ...
    children: [(0, import_jsx_runtime5.jsxs)(PickersCalendarDayHeader, {
      ...
      children: [displayWeekNumber && (0, import_jsx_runtime5.jsx)(PickersCalendarWeekNumberLabel, {
        variant: "caption",
        role: "columnheader",
        "aria-label": translations.calendarWeekNumberHeaderLabel,
        className: classes.weekNumberLabel,
        children: translations.calendarWeekNumberHeaderText
      }), getWeekdays(utils, now).map((weekday, i) => (0, import_jsx_runtime5.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
    ...
    }), loading ? (0, import_jsx_runtime5.jsx)(PickersCalendarLoadingContainer, {
      className: classes.loadingContainer,
      children: renderLoading()
    }) : (0, import_jsx_runtime5.jsx)(PickersCalendarSlideTransition, _extends({
      ...
      children: (0, import_jsx_runtime5.jsx)(PickersCalendarWeekContainer, {
        ref: slideNodeRef,
        role: "rowgroup",
        ...
        children: weeksToDisplay.map((week, index) => (0, import_jsx_runtime5.jsxs)(PickersCalendarWeek, {
          ...
          children: [displayWeekNumber && (0, import_jsx_runtime5.jsx)(PickersCalendarWeekNumber, {
            className: classes.weekNumber,
            role: "rowheader",
            "aria-label": translations.calendarWeekNumberAriaLabelText(utils.getWeekNumber(week[0])),
            children: translations.calendarWeekNumberText(utils.getWeekNumber(week[0]))
          }), week.map((day, dayIndex) => (0, import_jsx_runtime5.jsx)(WrappedDay, {
            parentProps: props,
            day,
...
var PickersMonth = React9.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
  ...
  return (0, import_jsx_runtime6.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime6.jsx)(MonthButton, _extends({}, monthButtonProps))
  }));
});
...
var PickersYear = React12.memo(function PickersYear2(inProps) {
  ...
  return (0, import_jsx_runtime8.jsx)(PickersYearRoot, _extends({
    ...
    children: (0, import_jsx_runtime8.jsx)(YearButton, _extends({}, yearButtonProps))
  }));
});
...
var IconButton = React15.forwardRef(function IconButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsx)(IconButtonRoot, {
    className: clsx_default(classes.root, className),
    centerRipple: true,
...
var ArrowDropDownIcon = createSvgIcon((0, import_jsx_runtime13.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
var ArrowLeftIcon = createSvgIcon((0, import_jsx_runtime13.jsx)("path", {
  d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z"
}), "ArrowLeft");
var ArrowRightIcon = createSvgIcon((0, import_jsx_runtime13.jsx)("path", {
  d: "M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z"
}), "ArrowRight");
var CalendarIcon = createSvgIcon((0, import_jsx_runtime13.jsx)("path", {
  d: "M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z"
}), "Calendar");
var ClockIcon = createSvgIcon((0, import_jsx_runtime13.jsxs)(React18.Fragment, {
...
var DateRangeIcon = createSvgIcon((0, import_jsx_runtime13.jsx)("path", {
  d: "M9 11H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2zm2-7h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z"
}), "DateRange");
var TimeIcon = createSvgIcon((0, import_jsx_runtime13.jsxs)(React18.Fragment, {
  children: [(0, import_jsx_runtime13.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime13.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var ClearIcon = createSvgIcon((0, import_jsx_runtime13.jsx)("path", {
...
var _excluded8 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId"];
...
var _excluded9 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "timezone", "format"];
...
var PickersCalendarHeader = React21.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ...
    children: [(0, import_jsx_runtime15.jsxs)(PickersCalendarHeaderLabelContainer, {
      ...
      children: [(0, import_jsx_runtime15.jsx)(PickersFadeTransitionGroup, {
        reduceAnimations,
        transKey: label,
        children: (0, import_jsx_runtime15.jsx)(PickersCalendarHeaderLabel, {
          id: labelId,
          ownerState,
          className: classes.label,
          children: label
        })
      }), views.length > 1 && !disabled && (0, import_jsx_runtime15.jsx)(SwitchViewButton, _extends({}, switchViewButtonProps, {
        children: (0, import_jsx_runtime15.jsx)(SwitchViewIcon, _extends({}, switchViewIconProps))
      }))]
    }), (0, import_jsx_runtime15.jsx)(Fade_default, {
      in: view === "day",
      children: (0, import_jsx_runtime15.jsx)(PickersArrowSwitcher, {
        slots,
        slotProps,
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    ...
    renderLoading: themeProps.renderLoading ?? (() => (0, import_jsx_runtime16.jsx)("span", {
      children: "..."
    })),
    minDate: applyDefaultDate(utils, themeProps.minDate, defaultDates.minDate),
    maxDate: applyDefaultDate(utils, themeProps.maxDate, defaultDates.maxDate)
...
var DateCalendar = React22.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime16.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
      slots,
      slotProps
    })), (0, import_jsx_runtime16.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
